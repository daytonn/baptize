...
function __baptize_config {
  ...
  if [ "$cmd" ] && [ "$cmd" != "show" ]; then
    ...
    echo -e "${BAPTIZE_PROMPT_COLOR}BAPTIZE_PROMPT_COLOR${CEND}"
    echo -e "${BAPTIZE_BAPTIZE_PROMPT_ICON_COLOR}BAPTIZE_BAPTIZE_PROMPT_ICON_COLOR${CEND}"
    echo -e "BAPTIZE_PROMPT_ICON: ${BAPTIZE_PROMPT_ICON}"
    echo -e "BAPTIZE_PROMPT_CONTENT: ${BAPTIZE_PROMPT_CONTENT}"
    echo -e "BAPTIZE_PROMPT_2_ARROW: ${BAPTIZE_PROMPT_2_ARROW}"
    ...
    echo -e "BAPTIZE_GIT_PULL_ICON: $BAPTIZE_GIT_PULL_ICON"
    echo -e "BAPTIZE_GIT_PUSH_ICON: $BAPTIZE_GIT_PUSH_ICON"
    echo -e "BAPTIZE_GIT_CLEAN_ICON: $BAPTIZE_GIT_CLEAN_ICON"
    ...
    echo -e "${BAPTIZE_GIT_STATS_SEPARATOR_COLOR}BAPTIZE_GIT_STATS_SEPARATOR_COLOR${CEND}"
  fi
}
